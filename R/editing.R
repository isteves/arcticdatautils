...
#' @param metadata_path (character) Optional. EML R object or path to a metadata file to update with. If this is not set, the existing metadata document will be used.
